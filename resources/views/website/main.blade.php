								        ...
								        <ul class="nav navbar-nav">
				            				...
				            				<li class="li-sub">
				                    			...
				                    			<ul class="navbar-sub">
				                    				...
				                    				<li class="li-sub-2">
				                    					<a href="{{ route('indexCode', ['code' => $itemMoBile->code]) }}">
				                    						<i class="fa fa-angle-right"></i> {{ $itemMoBile->name }}
				                    					</a>
                                                        ...
                                                        <ul class="navbar-sub-2">
                                                            ...
                                                            <li class="li-sub-3">
                                                                <a href="{{ route('indexCode', ['code' => $itemMoBileCon->code]) }}">
                                                                    <i class="fa fa-angle-right"></i> {{ $itemMoBileCon->name }}
                                                                </a>
                                                                ...
                                                                <ul class="navbar-sub-3">
                                                                  ...
                                                                  <li>
                                                                    <a href="{{ route('indexCode', ['code' => $itemMoBileConCon->code]) }}">
                                                                      <i class="fa fa-angle-right"></i> {{ $itemMoBileConCon->name }}
                                                                    </a>
                                                                  </li>
                                                                  @endforeach
                                                                </ul>
	        ...
	        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
	            <ul class="nav sidebar-nav">
	                ...
	                <li class="sidebar-brand">
	                    <form class="navbar-form navbar-right" action="{{ route('indexCode', ['code' => 'tim-kiem']) }}" method="post">
					    	@csrf
						  	<div class="input-group">
    				...
    				<li>
            			...
            			<ul>
            				@foreach($danhmucSanPhamMenuMobile2 as $itemMoBile)
            				<li>
            					<a href="{{ route('indexCode', ['code' => $itemMoBile->code]) }}"><i class="fa fa-angle-right"></i> {{ $itemMoBile->name }}</a>
                              	<?php $danhmucSanPhamMenuMobile3 = DB::table('danhmucsanpham')->where('danhmuccha_id', $itemMoBile->id)->where('status', 1)->orderBy('vitri', 'ASC')->get() ?>
                                  @if(count($danhmucSanPhamMenuMobile3) > 0)
                                  <ul>
                                    @foreach($danhmucSanPhamMenuMobile3 as $itemMoBileCon)

...
@section('meta_tags')
    ...
    <meta property="og:title" content="{{$danhmucsanpham->title ?? $danhmucsanpham->name}}" />
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="detail-content">
                        ...
                        @if(count($danhmucsanphamCon) > 0)
                        <div class="detail-content-body-product">
                            
                            <div class="row">
                            @foreach($danhmucsanphamCon as $item)
                            <div class="col-md-3 col-xs-6">
                                <div class="box-product-index margin-bottom-10">
                                    <div class="box-product-index-img box-cate-img-page">
                                        <a href="{{ route('indexCode', ['code' => $item->code]) }}" class="a-img-product">
                                            <img src="{{asset('upload/danhmucsanpham/'.$item->anhdaidien)}}" class="img-responsive" alt="{{$item->name}}">
                                        </a>
                                    ...
                                    <div class="box-product-index-cap">
                                        <div class="box-product-index-name box-cate-index-name">

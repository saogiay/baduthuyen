                            ...
                            <div class="new-block">
                                ...
                                <div class="new-block-cap">
                                    ...
                                    <div class="new-block-date">
                                        <i class="fa fa-calendar"></i> {{date("d/m/Y", strtotime($item2->created_at))}}
                                    </div>
                                </div>
                            </div>
                            @endforeach
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                ...
                                <?php $a += 1; ?>
                                <div id="cate_{{ $item2->id }}" class="tab-pane fade in @if($a == 1)<?php echo 'active'?>@endif">
                                    <div class="row">
                                      
                                      	<?php $danhmucconIds = DB::table('danhmucsanpham')
                                            ->where('danhmuccha_id', $item2->id)
                                            ->get()
                                            ->pluck('id')
                                            ->toArray();
                                        $sanpham = DB::table('sanpham')
                                            ->whereIn('danhmucsanpham_id', $danhmucconIds)
                                            ->orWhere('danhmucsanpham_id', $item2->id)
                                            ->where('status', 1)
                                            ->orderBy('id', 'desc')
                                            ->limit(10)
                                            ->get(); ?>
                ...
                <div class="about-block-more cate-block-more">
                    <a href="{{ route('indexCode', ['code' => $cha->code]) }}"><i class="fa fa-angle-right"></i> Xem tất cả</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="block-new-content">
                    ...
                    <div class="fb-page"
                         data-href="{{ $cauhinh->fanpage }}"
                         data-tabs="timeline" data-width="400" data-height="400"

				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr data-key="1">
							...
							<td class="text-center">
								<a class="nut-chuc-nang" href="admin/slider/update/{{$item->id}}" title="Sửa dữ liệu">
									<i class="fa fa-edit"></i>
								</a>
							</td>
							<td class="text-center">
								<a class="text-danger nut-chuc-nang" href="admin/slider/delete/{{$item->id}}" title="Xóa dữ liệu" onclick="return confirm('Bạn có muốn xóa không ?')">

...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="{{ url('admin/gioithieu/update/1') }}"><i class="fa fa-info-circle"></i><span> Giới
                                thiệu</span></a>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            <li>
                                <a href="{{ url('admin/danhmucbaiviet/index') }}"><i class="fa fa-table"></i><span>
                                        Danh mục</span></a>
                            </li>
                            <li>
                                <a href="{{ url('admin/baiviet/index') }}"><i class="fa fa-edit"></i><span> Bài
                                        viết</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            <li>
                                <a href="{{ url('admin/danhmucsanpham/index') }}"><i class="fa fa-table"></i><span>
                                        Danh mục sản phẩm</span></a>
                            </li>
                            <li>
                                <a href="{{ url('admin/sanpham/index') }}"><i class="fa fa-shopping-cart"></i><span>
                                        Sản phẩm</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ url('admin/slider/index') }}"><i class="fa fa-picture-o"></i><span>
                                Slider</span></a>
                    </li>
                    <!-- <li>
  <a href="{{ url('admin/thongtinlienhe/index') }}"><i class="fa fa-comments"></i><span> Thông tin liên hệ</span></a>
                    ...
                    <li>
                        <a href="{{ url('admin/cauhinh/update/1') }}"><i class="fa fa-cog"></i><span> Cấu
                                hình</span></a>
                    </li>
                    <li>
                        <a href="{{ url('admin/cauhinhseo/update/1') }}"><i class="fa fa-rocket"></i><span> Cấu hình
                                seo</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('admin/tuvan/index') }}"><i class="fa fa-comments"></i><span> Tư vấn</span></a>
                    </li>
                </ul>
            </section>
            <!-- /.sidebar -->

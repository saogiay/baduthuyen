                        ...
                        <tbody class="table-sanpham-body">
                            @foreach ($sanpham as $item)
                                <tr data-key="1">
                                    ...
                                    <td width="7%">
                                        <img src="{{ asset('storage/sanpham/' . $item->anhdaidien) }}" alt="{{ $item->alt_avatar }}"
                                    ...
                                    <td class="text-center">
                                        <a class="nut-chuc-nang" href="admin/sanpham/update/{{ $item->id }}"
                                            title="Sửa dữ liệu">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a class="text-danger nut-chuc-nang" href="admin/sanpham/delete/{{ $item->id }}"

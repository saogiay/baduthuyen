                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <input type="text" class="form-control" name="name"
                                    placeholder="Nhập tên bài viết... " aria-required="true" value="{{ $baiviet->name }}">
                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <input type="text" class="form-control" name="keyword"
                                    placeholder="Nhập keyword... " aria-required="true" value="{{ $baiviet->keyword }}">
                                <div class="help-block"></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="field-caterory-name">
                                ...
                                <select class="form-control" name="danhmucbaiviet_id">
                                    ...
                                    @foreach ($danhmucbaiviet as $item)
                                        <option @if ($baiviet->danhmucbaiviet_id == $item->id) {{ 'selected' }} @endif
                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option value="0" <?php if ($baiviet->status == 0 or $baiviet->status == 2) {
                                        echo 'selected';
                                    } ?>>Không hiển thị</option>
                                    <option value="1" <?php if ($baiviet->status == 1) {
                                        echo 'selected';
                                    } ?>>Hiển thị</option>
                                </select>
                                <div class="help-block"></div>
                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <select class="form-control" name="status2">
                                    <option value="2">Lựa chọn trạng thái</option>
                                    <option value="0" <?php if ($baiviet->status2 == 0 or $baiviet->status2 == 2) {
                                        echo 'selected';
                                    } ?>>Không hiển thị</option>
                                    <option value="1" <?php if ($baiviet->status2 == 1) {
                                        echo 'selected';
                                    } ?>>Hiển thị</option>
                                </select>
                                <div class="help-block"></div>
                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <select class="form-control" name="status3">
                                    <option value="2">Lựa chọn trạng thái</option>
                                    <option value="0" <?php if ($baiviet->status3 == 0 or $baiviet->status3 == 2) {
                                        echo 'selected';
                                    } ?>>Không hiển thị</option>
                                    <option value="1" <?php if ($baiviet->status3 == 1) {
                                        echo 'selected';
                                    } ?>>Hiển thị</option>
                                </select>
                                <div class="help-block"></div>
                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <select class="form-control" name="status_foot">
                                    <option value="2">Lựa chọn trạng thái</option>
                                    <option value="0" <?php if ($baiviet->status_foot == 0 or $baiviet->status_foot == 2) {
                                        echo 'selected';
                                    } ?>>Không hiển thị</option>
                                    <option value="1" <?php if ($baiviet->status_foot == 1) {
                                        echo 'selected';
                                    } ?>>Hiển thị</option>
                                </select>
                                <div class="help-block"></div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <textarea class="form-control" id="editor" rows="7" name="noidungbaiviet"
                                    placeholder="Nhập nội dung bài viết ...">{{ $baiviet->noidungbaiviet }}</textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-7 col-xs-12">
                            <div class="field-caterory-name">
                                ...
                                <textarea class="form-control" rows="7" name="description"
                                    ...
                                    onKeyUp="CountRight(this.form.description,this.form.right,300);" placeholder="Nhập thẻ description ...">{{ $baiviet->description }}</textarea>
                                <div class="help-block"></div>
                            </div>
                        </div>
                        <div class="col-md-1">

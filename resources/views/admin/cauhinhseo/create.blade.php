...
<section class="content-header">
    <h1>
        Thêm mới cấu hình seo
    </h1>
</section>
<div class="content">
	<form action="admin/cauhinhseo/create" method="post" enctype="multipart/form-data">
	    	...
	    	<div class="row">
	    		<div class="col-md-7 col-xs-12">
	        		<div class="field-caterory-name">
						...
						<textarea class="form-control" rows="7" name="analytics" placeholder="Nhập google analytics ..."></textarea>
						<div class="help-block"></div>
					</div>
				</div>
	    	</div>
	    	...
	    	<div class="row">
	    		<div class="col-md-7 col-xs-12">
	        		<div class="field-caterory-name">
						...
						<textarea class="form-control" rows="7" name="webmastertool" placeholder="Nhập webmaster tools ..."></textarea>
						<div class="help-block"></div>
					</div>
				</div>
	    	</div>
	    	...
	    	<div class="row">
	    		<div class="col-md-7 col-xs-12">
	        		<div class="field-caterory-name">
						...
						<textarea class="form-control" rows="7" name="script" placeholder="Nhập mã nhúng script ..."></textarea>
						<div class="help-block"></div>
					</div>
				</div>
	    	</div>
